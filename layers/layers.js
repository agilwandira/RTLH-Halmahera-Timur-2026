...
lyr_RTLHWAILUKUM_2.set('fieldLabels', {'Id': 'inline label - always visible', 'Nama_KK': 'inline label - always visible', 'No_KK': 'inline label - always visible', 'NIK': 'inline label - always visible', 'Alamat': 'inline label - always visible', 'Desa': 'inline label - always visible', 'Kecamatan': 'inline label - always visible', 'Kep_Sertif': 'inline label - always visible', 'Luas_Tanah': 'inline label - always visible', 'Koor_X': 'inline label - always visible', 'Koor_Y': 'inline label - always visible', 'FOTO': 'inline label - always visible', });
